package uzumtech.jdeliveryservice.handler;
...
import uzumtech.jdeliveryservice.exception.HttpClientException;
import uzumtech.jdeliveryservice.exception.HttpServerException;

import static uzumtech.jdeliveryservice.constant.enums.Error.*;
import static uzumtech.jdeliveryservice.constant.enums.ErrorType.*;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorDto> handleException(final HttpClientException ex) {
    ...
    protected ResponseEntity<ErrorDto> handleException(final HttpServerException ex) {
